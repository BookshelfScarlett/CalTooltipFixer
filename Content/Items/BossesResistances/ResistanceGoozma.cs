...
namespace CalTooltipFixer.Content.Items.BossesResistances
{
    ...
    public class ResistanceGoozma : ModItem, ILocalizedModType
    {
        public new string LocalizationCategory => "ResistanceItem";
        public Mod TheMod = CalTooltipFixer.Hunt;
        public int SuperBoss => TheMod.Find<ModNPC>(TooltipConstants.GoozmaSuperBoss).Type;
        public override bool IsLoadingEnabled(Mod mod) => CalTooltipFixer.Hunt is null; 
        ...
        [
            ...
            nameof(TheJailor),
            nameof(Condemnation),
            nameof(PrimordialAncient),
            nameof(GodSlayerSlug),
            nameof(HolyFireBullet),
            nameof(PridefulHuntersPlanarRipper),
            nameof(Vehemence),
            nameof(Wrathwing),
            nameof(ArkoftheCosmos),
            nameof(PhotonRipper),
            nameof(SpineOfThanatos),
            nameof(AtlasMunitionsBeacon)
        ];
        public static Vector2 BossHeadBox => new(28, 42);
        public static string WeaponMod => "CalamityMod";
        public static void SetResistanceBoolen(TooltipPlayer player) => player.ResistanceGoozmaBool = true;
        ...
        public override bool? UseItem(Player player)
        {
            ...
            //设置Boss对应的boolen
            modPlayer.ResistanceGoozmaBool = true;
            return base.UseItem(player);
        }
